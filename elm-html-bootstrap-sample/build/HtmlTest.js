...
Elm.HtmlTest = Elm.HtmlTest || {};
Elm.HtmlTest.make = function (_elm) {
   "use strict";
   _elm.HtmlTest = _elm.HtmlTest || {};
   if (_elm.HtmlTest.values)
   return _elm.HtmlTest.values;
   var _N = Elm.Native,
         ...
         {case "_Tuple2":
            return A4(Html.node,
              ...
              _L.fromArray([A4(Html.node,
                           ...
                           _L.fromArray([]),
                           _L.fromArray([]),
                           _L.fromArray([Html.text(String.show(_v0._0))]))
                           ,A4(Html.node,
                           "td",
                           _L.fromArray([]),
                           _L.fromArray([]),
                           _L.fromArray([Html.text(String.show(_v0._1))]))]));}
         _E.Case($moduleName,
         "between lines 7 and 10");
      }();
   };
   var tbl = function (dat) {
      return A4(Html.node,
      "table",
      ...
      _L.fromArray([A4(Html.node,
                   ...
                   _L.fromArray([A4(Html.node,
                                ...
                                _L.fromArray([]),
                                _L.fromArray([]),
                                _L.fromArray([Html.text("Mouse X")]))
                                ,A4(Html.node,
                                "th",
                                _L.fromArray([]),
                                _L.fromArray([]),
                                _L.fromArray([Html.text("Mouse Y")]))]))]))
                   ,A4(Html.node,
                   "tbody",
                   _L.fromArray([]),
                   _L.fromArray([]),
                   A2(List.map,data2line,dat))]));
   };
   var body = function (dat) {
      return A4(Html.node,
      "div",
      _L.fromArray([A2(Html._op[":="],
      "className",
      ...
      _L.fromArray([A4(Html.node,
                   ...
                   _L.fromArray([A4(Html.node,
                                ...
                                _L.fromArray([]),
                                _L.fromArray([]),
                                _L.fromArray([Html.text("Elm/Twitter Bootstrap")]))
                                ,A4(Html.node,
                                "p",
                                _L.fromArray([]),
                                _L.fromArray([]),
